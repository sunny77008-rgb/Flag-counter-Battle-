...
function switchApiKey() {
  ...
  // ❌ REMOVED: dailyQuotaUsed[currentKeyIndex] = 0;
  ...
  try {
    ...
    res.data.items.forEach(msg => {
      ...
      if (countryCode) {
        ...
        // 🔥 SET TARGET: Only if no target yet and delay passed
...
io.on("connection", (socket) => {
  ...
  socket.on("startRound", () => {
    ...
    // Reset previous round if exists
    ...
    // 🔴 3 seconds delay before accepting target
    setTimeout(() => {
