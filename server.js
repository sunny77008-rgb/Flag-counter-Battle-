...
io.on("connection", (socket) => {
  ...
  socket.on("resetVotes", () => {
    ...
    votes = {};
    lastVoter = {};
    processedMessages.clear(); // Purani memory saaf
    
    // Frontend ko turant update bhejo taaki screen zero ho jaye
    io.emit("updateVotes", { votes: {}, lastVoter: {} });
    console.log("Votes reset and Message history cleared");
  });
});
